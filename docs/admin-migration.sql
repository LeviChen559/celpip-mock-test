...
alter table public.profiles add column if not exists role text not null default 'improver' check (role in ('admin', 'teacher', 'editor', 'user', 'improver', 'intensive', 'guarantee'));
